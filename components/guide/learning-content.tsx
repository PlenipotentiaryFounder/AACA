...
export default function LearningContent({ 
  ...
  // Keep the state management for tabs
    ...
    <div className="container mx-auto px-4 py-6 md:py-10">
      ...
      <div className="space-y-8">
        ...
        {currentTab === 'techniques' && (
           <div className="space-y-8 pt-6">
             {/* Section 3.4: Study Habits Intro */}
             <Card>
               <CardHeader>
             ...
             <Card>
              ...
              {/* Section 3.4: Burnout & Prioritization */}
              <Card>
                 <CardHeader>
             ...
             {/* Existing Top 5 + Practical Methods from 3.4 */}
             <Card>
               <CardHeader>
             ...
             {/* Section 3.5: Levels of Learning */}
             <Card>
                <CardHeader>
        ...
        {currentTab === 'overload' && (
           <div className="space-y-8 pt-6">
             {/* Section 3.1: Maslow's Hierarchy */}
             <Card>
               <CardHeader>
             ...
             {/* Section 3.2: Flight Instruction is Hard */}
             <Card>
               <CardHeader>
             ...
             {/* Section 3.3: Defense Mechanisms */}
             <Card>
               <CardHeader>
             ...
             {/* Existing Burnout Alert - Still relevant */}
      ...
      {/* Pass pathname to GuideNavigation */}
      <GuideNavigation 
        prevPage={prevPage ?? undefined} // Use prevPage from props
        nextPage={nextPage ?? undefined} // Use nextPage from props
        currentPageUrl={pathname} // Pass the pathname
        nextTopicSegue={nextTopicSegue} // Use nextTopicSegue from props
      />
    </div>
  );
}