...
export default function ProfessionalPilot() {
  return (
    <div className="container mx-auto px-4 py-6 md:py-10">
      ...
      <div className="mb-12 rounded-xl border bg-card p-6 shadow-sm">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="font-display text-2xl font-bold text-aa-navy">Chapter 9 – Your Reputation Starts Now</h2>
      ...
      <Tabs defaultValue="professionalism" className="w-full">
        <TabsList className="mb-8 grid w-full grid-cols-2 md:grid-cols-4">
          <TabsTrigger value="professionalism">Being Professional</TabsTrigger>
          <TabsTrigger value="networking">Networking</TabsTrigger>
          <TabsTrigger value="community">Aviation Community</TabsTrigger>
          <TabsTrigger value="learning">Continuous Learning</TabsTrigger>
        </TabsList>

        {/* Section 1: What It Means to Be a Professional Pilot */}
        <TabsContent value="professionalism" className="space-y-8">
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start">
                    <Users className="mr-2 h-4 w-4 text-aa-blue mt-0.5" />
                    <span>
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent>
                ...
                <ul className="space-y-3 text-sm">
                  ...
                  <li className="flex items-start">
                    <MessageSquare className="mr-2 h-4 w-4 text-green-600 mt-0.5" />
                    <span>Take ownership when you mess up—and learn from it.</span>
                  </li>
                  <li className="flex items-start">
                    <Heart className="mr-2 h-4 w-4 text-green-600 mt-0.5" />
              ...
              <CardContent>
                ...
                <div className="space-y-2 text-sm">
                  <p className="flex items-center">
                    <span className="mr-2 inline-block h-4 w-4 rounded-full bg-red-100 text-center text-xs font-medium text-red-800 dark:bg-red-900 dark:text-red-300">
                      ✗
                    </span>
        ...
        {/* Section 2: Networking & Career Advancement */}
        <TabsContent value="networking" className="space-y-8">
          <div className="grid gap-6 md:grid-cols-2">
            <div>
              <h2 className="font-display text-2xl font-bold text-aa-navy">9.2 – Networking & Career Advancement</h2>
              <p className="mt-2 text-muted-foreground">
          ...
          <div className="rounded-xl border bg-card p-6 shadow-sm">
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-lg border bg-background p-4 hover:shadow-md transition-shadow">
                <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300">
                  <Users className="h-5 w-5" />
                </div>
                <h4 className="font-medium">Connect with Classmates & Instructors</h4>
                <ul className="mt-3 space-y-2 text-sm">
                  <li className="flex items-start">
                    <ChevronRight className="mr-1 h-3 w-3 text-muted-foreground mt-1" />
              ...
              <div className="mt-4 space-y-4">
                <div className="rounded-lg bg-background p-4">
                  <div className="flex items-start">
                    <div className="mr-3 flex h-8 w-8 items-center justify-center rounded-full bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300">
        ...
        {/* Section 3: Volunteering & Being Part of the Aviation Community */}
          ...
          <div className="rounded-xl border bg-card p-6 shadow-sm">
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-3">
              <div className="group rounded-xl border bg-background p-5 transition-all hover:border-green-500 hover:shadow-md">
                <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-green-100 text-green-700 transition-colors group-hover:bg-green-500 group-hover:text-white dark:bg-green-900 dark:text-green-300">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border bg-muted/50 p-6">
              ...
              <div className="mt-4 space-y-4">
                <div className="rounded-lg border bg-background p-4">
                  <div className="flex items-start">
                    <div className="mr-3 flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300">
        ...
        {/* Section 4: Always Be Learning – The Mindset of a Great Pilot */}
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-lg border bg-card p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-2">
                ...
                <div className="flex items-center rounded-lg bg-muted p-3">
                  <Compass className="mr-2 h-4 w-4 text-amber-500" />
          ...
          <div className="rounded-xl border bg-card p-6 shadow-sm">
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="group rounded-xl border bg-background p-5 transition-all hover:border-blue-500 hover:shadow-md">
                <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-blue-700 transition-colors group-hover:bg-blue-500 group-hover:text-white dark:bg-blue-900 dark:text-blue-300">
